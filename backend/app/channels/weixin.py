...
from app.channels.helpers import get_media_dir, get_runtime_subdir, split_message
...
class WeixinChannel(BaseChannel):
        ...
        try:
            ...
            for media_path in (msg.media or []):
                try:
                    ...
                    logger.error("Failed to send WeChat media %s: %s", media_path, http_err)
    ...
    async def _start_typing(self, chat_id: str, context_token: str = "") -> None:
        ...
        try:
            ...
            logger.debug("WeChat typing indicator start failed for %s: %s", chat_id, e)
            return
    ...
    async def _stop_typing(self, chat_id: str, *, clear_remote: bool) -> None:
        ...
        try:
            ...
            logger.debug("WeChat typing clear failed for %s: %s", chat_id, e)
